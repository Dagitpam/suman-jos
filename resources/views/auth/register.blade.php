          ...
          <div class="card-body text-center">
            ...
            <form method="POST" action="{{ route('register') }}">
              @csrf
                ...
                <div class="md-form mat-2" style="margin-bottom: 10px;">
                  <label for="username" style="float:left; font-weight: bold;">Name</label>
                ...
                <div class="md-form mat-2" style="margin-bottom: 10px; font-weight: bold;">
                  <label for="password2" style="float:left;">Password confirmation</label>
                  <input type="password" id="password2" class="form-control" name="password_confirmation" required autocomplete="new-password">
                </div>
                
                <div class="card-foter text-right">
                    <button type="submit" class="btn btn-outline-primary" style="width: 140px;">Sign up</button>
                </div>
            </form>
          </div>
        </div>
